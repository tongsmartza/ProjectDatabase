...
$sql = "INSERT INTO personaldetail (Username,EmployeeID,FirstName,LastName,Password,DepartmentName,Phone,Facebook,LineID,StaffTeamID)
VALUES ('$Username','$EmployeeID','$FirstName','$LastName','$Password','$DepartmentName','$Phone','$Facebook','$LineID','Nope');";
