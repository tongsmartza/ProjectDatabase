<?php
    ...
    $result = mysqli_query($conn, "SELECT * FROM personaldetail WHERE Username='nakisdada'");
...
<body>
  ...
  <div class="column right">
    <h2>ข้อมูลส่วนตัว</h2>
    <h3>ชื่อ</h3><?php echo $data['Firstname']; ?>
    <h3>นามสกุล</h3><?php echo $data['Lastname']; ?>
